<x-admin-master>
    @section('content')
        <h1 class="text-dark">Edit {{ $permission->name }} permission</h1>
        ...
        <div class="row">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form action="{{ route('permissions.update', $permission->id) }}" method="post">
                            ...
                            <button class="btn btn-warning btn-block" type="submit">Edit permission</button>
                        </form>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-9">
                <div class="card shadow mb-4">
                    <div class="card-header">
                        <h6 class="m-0 font-weight-bold text-primary">{{ $permission->name }} permissions table</h6>
                    </div>
                    <div class="card-body">
